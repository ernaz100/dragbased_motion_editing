...
from backend.human3dml_util.paramUtil import *
from backend.human3dml_util.quaternion import *
from backend.human3dml_util.skeleton import Skeleton
...
def process_file(positions, feet_thre, tgt_offsets, l_idx1, l_idx2, fid_r, fid_l, face_joint_indx, n_raw_offsets, kinematic_chain):
...
def prepare_smpl_for_priorMDM(smpl_sequence, fps=20):
    """
    ...
    data, global_positions, positions, l_velocity = process_file(smpl_sequence, 0.002, tgt_offsets, l_idx1, l_idx2, fid_r, fid_l, face_joint_indx, n_raw_offsets, kinematic_chain)
